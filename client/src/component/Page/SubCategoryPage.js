...
function SubCategoryPage(props) {
    ...
    for(let i = 0;i<ConstSubCategory.subCategory.length;i++){
        if(slug=== ConstSubCategory.subCategory[i].value){
            catego = ConstSubCategory.subCategory[i].key;
            break
        }
    }
    ...
    for(let i = 0;i<ConstSubCategory.category.length;i++){
        if(locate.pathname.split('/')[2]=== ConstSubCategory.category[i].value){
            cate = ConstSubCategory.category[i].key
            console.log('11')
            break
        }
    }
            ...
            <div className="grid1 wide">
                <div className="section-top">
                    <div className="section-top-left">
                        ...
                        <Link to={`/danh-muc/${locate.pathname.split('/')[2]}`} className="text">{cate}</Link>
                        <div className="separate">/</div>
                        <div className="text-2">{catego}</div>
                    </div>
